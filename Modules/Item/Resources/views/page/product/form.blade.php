...
<div class="form-group">
    ...
    <div class="col-md-4 col-sm-4 {{ $errors->has('item_product_buy') ? 'has-error' : ''}}">
        {!! Form::text('item_product_buy', null, ['class' => 'form-control']) !!}
        {!! $errors->first('item_product_buy', '<p class="help-block">:message</p>') !!}
    </div>

    {!! Form::label('name', __('Sell'), ['class' => 'col-md-2 col-sm-2 control-label']) !!}
    <div class="col-md-4 col-sm-4 {{ $errors->has('item_product_sell') ? 'has-error' : ''}}">
        {!! Form::text('item_product_sell', null, ['class' => 'form-control']) !!}
        {!! $errors->first('item_product_sell', '<p class="help-block">:message</p>') !!}
    </div>
